  ...
  return (
    <div className='flex flex-col my-3 items-center ' >
        <div className='flex flex-col items-center'>
            <span class="bg-gradient-to-r from-color-lightblue to-color-violet text-transparent font-poppins text-5xl font-semibold bg-clip-text py-2">Your adventure, your choice</span>
            <h1 className='font-poppins font-normal text-2xl text-color-stronggray py-2'>Find the one that best suits you</h1>
        </div>
        <div className='flex-row flex w-full justify-center my-8'>
